document.addEventListener("DOMContentLoaded", function () {
  ...
  let calendrier = new FullCalendar.Calendar(calendrierElement, {
    ...
    eventClick: function (info) {
      ...
      let modalSuppression = document.getElementById("modalRecetteCliquee");
    ...
    dateClick: function (info) {
      ...
      let modalPlanning = new bootstrap.Modal(
        document.getElementById("modalRecettes")
      );
      modalPlanning.show();
      ...
      document
        .getElementById("ajoutRecettePlanning")
        .addEventListener("click", function () {
          ...
          let recette = document.getElementById("recetteDropdown").value;
          let date = info.date;
          ...
          if (recetteExistante !== -1) {
            ...
            planning.push({ recette: recette, date: dateFormattee });
          }
